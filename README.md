...
An admin panel for menu items on Laravel 5 or Laravel 6, using [AfzalSabbir\CRUD](https://github.com/AfzalSabbir/crud). Add, edit, reorder, nest, rename menu items and link them to [AfzalSabbir\PageManager](https://github.com/AfzalSabbir/pagemanager) pages, external link or custom internal link. 
